...
{
    public class JobDriver_ProjectShield : JobDriver_CastAbility
    {
        ...
        public override IEnumerable<Toil> MakeNewToils()
        {
            ...
            Toil toil = ToilMaker.MakeToil("ProjectShield");
            toil.initAction = delegate
            {
                ...
                int shieldEnergy = (int)pawn.GetStatValue(StatDefOf.MechRemoteShieldEnergy);
                ProjectileInterceptor.maxHitPointsOverride = shieldEnergy;
                ProjectileInterceptor.currentHitPoints = shieldEnergy;
            };
